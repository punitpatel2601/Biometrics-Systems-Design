...
def calculate_singularities(im, angles, W, mask, tolerance=1):
    # Helder: modification to return the list of singularities coordinates
        ...
        for j in range(3, len(angles[i]) - 2):      # x
            ...
            if mask_flag == (W*5)**2:
                ...
                if singularity != "none":
                    ...
                    # RGB color in matplotlib should be normalized
                    singularities_lst.append([j*W,i*W,singularity])

    return singularities_lst, result
